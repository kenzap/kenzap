            ...
            <div class="container p-edit app-settings">
                ...
                <div class="d-flex justify-content-between bd-highlight mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" title="${__html("Start development mode")}" class="bi bi-play-circle form-text m-0 me-3 po start-dev-app ${global.state.dev[this.app.id].status == "stop" ? "" : "d-none"}" viewBox="0 0 16 16" data-id="${attr(this.app.id)}">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                            <path d="M6.271 5.055a.5.5 0 0 1 .52.038l3.5 2.5a.5.5 0 0 1 0 .814l-3.5 2.5A.5.5 0 0 1 6 10.5v-5a.5.5 0 0 1 .271-.445z"/>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-terminal form-text m-0 me-3 po start-terminal" viewBox="0 0 16 16" data-id="${attr(this.app.id)}">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-cloud-arrow-up form-text m-0 me-4 po app-publish" data-id="${attr(this.app.id)}" viewBox="0 0 16 16">
                        ...
                        <button class="btn btn-primary app-save" type="button">${__html('Save')}</button>
                    </div>
                </div>
                <div class="row-">
