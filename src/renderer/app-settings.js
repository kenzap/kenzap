            ...
            <div class="container p-edit app-settings">
                ...
                <div class="d-flex justify-content-between bd-highlight mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-cloud-arrow-up form-text m-0 me-3 po app-deploy app-publish" data-id="${attr(this.app.id)}" viewBox="0 0 16 16">
