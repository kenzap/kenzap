                ...
                return `
                                                            <tr>
                                                                ...
                                                                <td class="text-start" style="min-width:100px;">
                                                                    <span class="app-deploy app-list-publish" data-id="${attr(app.id)}">${formatStatus(app, global.state.dev[app.id].status)}</span>
                                                                ...
                                                                <td class="text-end">
                                                                    <div class="dropdown applicationsActionsCont">
                                                                        ...
                                                                        <ul class="dropdown-menu" aria-labelledby="applicationsActions0" style="">
                                                                            <li>
                                                                                <a class="dropdown-item po app-deploy d-flex align-items-center" href="#" data-id="${attr(app.id)}" >
