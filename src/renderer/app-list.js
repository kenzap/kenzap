...
export class AppList {
    ...
    constructor() {
        ...
        if (!global.state.pub) global.state.pub = {};
    ...
    view() {
        ...
        document.querySelector('body').innerHTML = `
            ...
            return `<option ${p.current ? 'selected' : ''} value="${attr(p.id)}">${html(p.project)}</option>`
                ...
                if (!global.state.pub[app.id]) global.state.pub[app.id] = {}
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="${app.status == "unpublished" ? "d-none" : ""} d-flex align-items-center">
                                                                        ...
                                                                        <div class="dropdown devToolsSyncCont d-flex form-text m-0 me-2 po" data-id="${attr(app.id)}">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" title="${__html("Start development mode")}" data-bs-toggle="dropdown" data-boundary="viewport" aria-expanded="false" class="bi bi-play-circle form-text m-0 po start-dev-app dropdown-toggle ${global.state.dev[app.id].status == "stop" ? "" : "d-none"}" viewBox="0 0 16 16" data-id="${attr(app.id)}">
                                                                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                                                ...
                                                                <td class="text-start" style="min-width:100px;">
                                                                    <div class="dropdown devToolsPublishCont d-flex form-text m-0 me-2 po" data-id="${attr(app.id)}">
                                                                        <span class="app-deploy app-list-publish" data-id="${attr(app.id)}" data-bs-toggle="dropdown" data-boundary="viewport" aria-expanded="false">${formatStatus(app, global.state.dev[app.id].status)}</span>
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-cloud-arrow-up form-text m-0 ms-3 po d-none app-deploy" data-id="${attr(app.id)}" viewBox="0 0 16 16">
                                                                ...
                                                                <td class="text-end">
                                                                    <div class="dropdown applicationsActionsCont">
                                                                        ...
                                                                        <ul class="dropdown-menu" aria-labelledby="applicationsActions0" style="">
                                                                            <li>
                                                                                <a class="dropdown-item po app-deploy d-flex d-none align-items-center" href="#" data-id="${attr(app.id)}" >
